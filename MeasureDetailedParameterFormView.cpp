...
void CMeasureDetailedParameterFormView::OnInitialUpdate()
{
	...
	m_comboStylusType.InsertString(1, L"r:0.2μm");
	m_comboStylusType.InsertString(1, L"r:0.7μm");
	m_comboStylusType.InsertString(1, L"r:2μm");
	m_comboStylusType.InsertString(1, L"r:2.5μm");
	m_comboStylusType.InsertString(2, L"r:5μm");
	m_comboStylusType.InsertString(3, L"r:10μm");
	m_comboStylusType.InsertString(4, L"r:12.5μm");
	m_comboStylusType.InsertString(5, L"r:25μm");
